...
<?php
//This section processed submissions from the login form
...
//Retrieve the id, firstname, lastname, fot the username and password combination
...
//run the query and asssign it to the variable $result
    ...
    //count the number of row that match the username/password combination
...
<p align="left"><input id = "submit" type = "submit" name ="submit" value ="login"  />
    &nbsp;
<p align="left"><input id = "reset" type = "reset" name ="reset" value ="cancel"  /></p>
</form>
