...
if($result) {
    echo '<table border="2">
    <tr><td><b>ID</br></td>
    <td><b>First Name</br></td>
    <td><b>Last Name</br></td>
    <td><b>Insurance Number</br></td>
    <td><b>Diagnose</br></td>
    </tr>';
    ...
    mysqli_free_result($result);
        ...
        echo '<p class="error"> If no record is shown, thi is because you had an incorrect or missing entry in search form.<br>Click the back button on the browser and try again.</p>';
